...
namespace Futzim
{
    public class Squad
    {
        ...
        {
            Slots.Add(new SquadSlot(Slots.Count, player, Slots.Count + 1, new Godot.Vector2(0.5f, 0.5f)));
        }
        ...
        public void AddPlayers(params Player[] players)
        {
            ...
            {
                Slots.Add(new SquadSlot(Slots.Count, p, Slots.Count + 1, new Godot.Vector2(0.5f, 0.5f)));
            }
        }
    }
}
